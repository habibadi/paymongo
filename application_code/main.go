...
// @Description Validates email address format - ALWAYS RETURNS 500 (for testing soft failure)
// @Tags validation
// @Accept json
// @Produce json
...
func main() {
	...
	fmt.Println("  POST /api/validate-email - Validate email (always returns 500)")
